            ...
            <div className="flex items-center gap-3 text-text-secondary flex-wrap justify-center sm:justify-start">
              ...
              <div className="flex items-center gap-2">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-7 h-7 rounded-[4px] bg-[#182028] hover:bg-[#222c38] text-text-secondary hover:text-[#e1306c] border border-[#28323e] flex items-center justify-center transition-colors"
                  title="Instagram (@chasingimpetus)"
                >
